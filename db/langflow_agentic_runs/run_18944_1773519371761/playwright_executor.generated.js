...
(async () => {
  ...
  const artifactsDir = "C:\\Users\\William\\Desktop\\Projects\\Genai_2026\\db\\langflow_agentic_runs\\run_18944_1773519371761";
  ...
  await page.locator("text=Jungle").first().waitFor({ state: 'visible', timeout: 10000 });
