...
(async () => {
  ...
  const artifactsDir = "C:\\Users\\William\\Desktop\\Projects\\Genai_2026\\db\\langflow_agentic_runs\\run_6596_1773519006600";
  ...
  await page.locator("text=Visible agent verification").first().waitFor({ state: 'visible', timeout: 10000 });
