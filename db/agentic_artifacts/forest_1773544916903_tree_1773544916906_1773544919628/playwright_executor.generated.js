...
async function run({ projectRoot, artifactsDir }) {
  ...
  await page.locator("text=Jungle\\nUpdated").first().click();
  await page.waitForTimeout(500);
  await expect(page.locator("#approve-run").first()).toBeVisible();
  await page.waitForTimeout(350);
  await page.screenshot({ path: path.join(artifactsDir, 'step_1773544919629.png'), fullPage: true });
