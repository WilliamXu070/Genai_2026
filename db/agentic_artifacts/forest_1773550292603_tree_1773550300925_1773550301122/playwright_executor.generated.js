...
async function run({ baseUrl, artifactsDir }) {
  ...
  await expect(page.locator("#stageLabel").first()).toContainText("Seed");
  ...
  await expect(page.locator("#stageLabel").first()).toContainText("Sprout");
  await page.waitForTimeout(500);
  await expect(page.locator("#scene").first()).toBeVisible();
  await page.waitForTimeout(500);
  await page.evaluate(async () => { const maxY = document.documentElement.scrollHeight - window.innerHeight; let y = 0; const stride = Math.max(64, Math.floor(window.innerHeight * 0.35)); while (y < maxY) { y = Math.min(maxY, y + stride); window.scrollTo(0, y); await new Promise((r) => setTimeout(r, 450)); } });
  ...
  await page.waitForTimeout(10000);
  await page.waitForTimeout(400);
  await expect(page.locator("#stageLabel").first()).toContainText("Stem");
  await page.waitForTimeout(500);
  await expect(page.locator("#scene").first()).toBeVisible();
  await page.waitForTimeout(500);
  await page.evaluate(async () => { const maxY = document.documentElement.scrollHeight - window.innerHeight; let y = 0; const stride = Math.max(64, Math.floor(window.innerHeight * 0.35)); while (y < maxY) { y = Math.min(maxY, y + stride); window.scrollTo(0, y); await new Promise((r) => setTimeout(r, 450)); } });
  ...
  await page.waitForTimeout(10000);
  await page.waitForTimeout(400);
  await expect(page.locator("#stageLabel").first()).toContainText("Leaves");
  await page.waitForTimeout(500);
  await expect(page.locator("#scene").first()).toBeVisible();
  await page.waitForTimeout(500);
  await page.evaluate(async () => { const maxY = document.documentElement.scrollHeight - window.innerHeight; let y = 0; const stride = Math.max(64, Math.floor(window.innerHeight * 0.35)); while (y < maxY) { y = Math.min(maxY, y + stride); window.scrollTo(0, y); await new Promise((r) => setTimeout(r, 450)); } });
  ...
  await page.waitForTimeout(10000);
  await page.waitForTimeout(400);
  await expect(page.locator("#stageLabel").first()).toContainText("Full Bloom");
  await page.waitForTimeout(500);
  await expect(page.locator("#scene").first()).toBeVisible();
  await page.waitForTimeout(500);
  } finally {
