...
async function run({ baseUrl, artifactsDir }) {
  ...
  await page.screenshot({ path: path.join(artifactsDir, 'step_1773562091434.png'), fullPage: true });
  ...
  await page.waitForTimeout(500);
  await page.locator("input[name=\"message\"]").first().fill("This is a test message.");
  await page.waitForTimeout(500);
  await page.locator("text=Send Message").first().click();
  await page.waitForTimeout(500);
